...
import { TelegramIconLarge } from '../../../components/icons/SocialIcons'; // Предполагается, что у вас есть иконка для Telegram
            ...
            <main className="min-h-screen relative overflow-hidden">
                ...
                <div className="max-w-3xl mx-auto text-center top-20 relative pt-72">
                    ...
                    >
                        ...
                        >
                            <span className="text-[#1DA1F2]">Grow your Telegram account</span> <br />fast & organically
                        </h1>
                        <div
